...
def bznsyp(metadata_path: str, column_sep='|') -> dict:
    text_dict = {}
...
if __name__ == '__main__':
    metadata_path = '/mnt/4CF66F5E440FD406/yozi/copus/BZNSYP_22050/metadata.csv'
    #metadata_path = '/home/copus/BZNSYP_22050/metadata.csv'
    d = get_preprocessor_by_name('bznsyp')(metadata_path)
